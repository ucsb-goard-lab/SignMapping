...
%% save
    ...
    if exist(AnalDir) == 0
        ...
        saveas(HorizRet,strcat(AnalDir,filename1,'.eps'))
...
%     clabel(C,'manual')
    ...
    if exist(AnalDir) == 0
        ...
        saveas(HorizRet_ContourAutumn,strcat(AnalDir,filename3,'.tif'))
        saveas(HorizRet_ContourAutumn,strcat(AnalDir,filename3,'.fig'))
        saveas(HorizRet_ContourAutumn,strcat(AnalDir,filename3,'.eps'))
        saveas(HorizRet_ContourHSV,strcat(AnalDir,filename4,'.tif'))
        saveas(HorizRet_ContourHSV,strcat(AnalDir,filename4,'.fig'))
        saveas(HorizRet_ContourHSV,strcat(AnalDir,filename4,'.eps'))
