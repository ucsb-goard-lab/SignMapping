...
%% Get kmaps for vert and horizontal
[kmap_vert] = getKmaps(anim,alt_expt,1,150);
[kmap_hor] = getKmaps(anim,azi_expt,1,150);

kmap_hor = fliplr(kmap_hor); %flip and rotate as necessary
% kmap_hor = rot90(rot90(rot90(kmap_hor)));
% 
kmap_vert = fliplr(kmap_vert);
% kmap_vert = rot90(rot90(rot90(kmap_vert)));
